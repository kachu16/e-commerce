...
const a = categories.map(c=> ({value:capitalizeFirstLetter(c), label:capitalizeFirstLetter(c.split('-').join(' ')), checked:false}));
console.log(a);
export const brands = [...new Set([...products.map(p => p.brand)])];
const b =brands.map(b=> ({value:b, label:capitalizeFirstLetter(b.split('-').join(' ')), checked:false}));
