...
const Checkout = () => {
  return (
    ...
    <form className='bg-white px-5 mt-8 py-12'>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 py-5 border-2 border-gray-200 border-solid px-2 my-5">
    ...
    <div className="mx-auto mt-8 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
